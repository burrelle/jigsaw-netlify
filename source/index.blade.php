...
<div class="container mx-auto px-8 py-8 lg:px-32 lg:py-20 pb-20">
    ...
    <div id="social" class="pt-12">
        <ul class="list-reset flex">
            <li><a href="https://github.com/burrelle"><svg class="mr-4 w-6 h-6 text-grey-darkest fill-current"
                        aria-labelledby="simpleicons-github-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a href="https://twitter.com/ev_burrell"><svg class="mr-4 w-6 h-6 text-grey-darkest fill-current"
                        aria-labelledby="simpleicons-twitter-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a href="https://linkedin.com/in/evan-burrell"><svg class="mr-4 w-6 h-6 text-grey-darkest fill-current"
                        aria-labelledby="simpleicons-linkedin-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
